...
<body>
	<div class="container-fluid chatterContainer">
		<div class="row-fluid">
		...
		$(function(){
			...
			app.BrainSocket.Event.listen('generic.event',function(msg){
				...
				if(msg.client.data.user_id == fake_user_id){
					$('#chat-log').append('<div class="alert alert-success">Me: '+msg.client.data.message+msg.client.data.alias+'</div>');

				}else{
					$('#chat-log').append('<div class="alert alert-info">Them: '+msg.client.data.message+msg.client.data.alias+'</div>');
				}
				$('.alert').last().focus();
			});
